...
(*) Lo script V7_CDU_RealTime_Intersezioni.py è stato completamente riprogettato per migliorare le prestazioni, nella versione 2.0 è capace di processare circa 6000 particelle per circa 35 layer tematici di sovrapposizione in un unico blocco con un tempo di esecuzione accettabile.
