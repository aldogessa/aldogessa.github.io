...
class LayerSelectionDialog(QDialog):
    def __init__(self, polygon_layers, parcel_layers, output_tables, active_layer, parent=None):
        ...
        # ------------------
        # Combo layer particelle (riconosciuto automaticamente e non modificabile)
        # ------------------
        ...
        # Se il layer attivo è valido e presente tra i layer particelle, usalo
...
def esegui_script():
    ...
    try:
        ...
        # 🔒 Layer dell’azione, non quello “attivo”
        layer_id = "[% @layer_id %]"
