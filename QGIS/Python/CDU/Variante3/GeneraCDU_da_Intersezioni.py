...
def export_selected_data_to_existing_table(template_path):
    try:
        ...
        layer = QgsProject.instance().mapLayersByName("IntersezioniCATRAS")[0] # Qui definire il nome del layer che contiene le intersezioni
...
template_file = os.path.join(QgsProject.instance().homePath(), "Immagini", "00_CDU_Schema.docx") # Qui definire il percorso del template preconfigurato
